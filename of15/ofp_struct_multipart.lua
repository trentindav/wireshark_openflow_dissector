...
fields.ofp_group_desc_type = ProtoField.new("Type", "of.ofp_group_desc.type", ftypes.UINT8, nil, base.DEC)
...
function ofp_group_desc(tvb, pinfo, tree)
    ...
    subtree:add(fields.pad3, tvb(10,3))
    subtree:add(fields.pad3, tvb(13,3))
    local offset = 16
